...
export const useGenerator = () => {
    ...
    const lowercaseLetters: Array<string> = charCode.map((char) => String.fromCharCode(char));
    const uppercaseLetters: Array<string> = lowercaseLetters.map((char) => char.toUpperCase());
     ...
     * @param {boolean} useLowercase Include lowercase charracters.
     * @param {boolean} useUppercase Include uppercase charracters.
     * @returns 
     */
    const generate = (passwordLength: number = 20, useNumbers: boolean = true, useSymbols: boolean = true, useLowercase: boolean = true, useUppercase: boolean = true) => {
        // Check passwordLength parameter.
        if (typeof passwordLength !== 'number') return {
            ok: false,
            error: {
                code: "0001",
        ...
        if (typeof useNumbers !== 'boolean') return {
            ok: false,
            error: {
                code: "0002",
        ...
        if (typeof useSymbols !== 'boolean') return {
            ok: false,
            error: {
                code: "0003",
        ...
        if (typeof useLowercase !== 'boolean') return {
            ok: false,
            error: {
                code: "0004",
        ...
        if (typeof useUppercase !== 'boolean') return {
            ok: false,
            error: {
                code: "0005",
